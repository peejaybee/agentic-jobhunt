...
1. **Evaluation Scope & Constraints**:
   ...
   - You MUST ONLY fail the evaluation (capping `match_score` at **0**) if the job description **explicitly mandates physical residency outside the United States** (e.g., "Must reside in UK/Europe/APAC", "Germany residents only") or **explicitly excludes candidates residing in the United States**, or **explicitly excludes candidates residing in Illinois**. Do NOT interpret general legal disclaimers, GDPR notices, or privacy policy statements referencing other countries (e.g. "For candidates in Australia see this privacy notice") as a geographic residency mandate.
